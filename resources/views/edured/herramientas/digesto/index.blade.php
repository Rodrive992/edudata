...
@section('content')
    <div class="container mx-auto px-4 py-8">
            ...
            <div class="p-6">
                ...
                <form action="{{ route('edured.herramientas.digesto.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            <label
                                class="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-1">Título</label>
                        ...
                        <div>
                            <label
                                class="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-1">Descripción</label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2 flex items-center gap-1">Archivo
                                PDF</label>
                            <div class="relative">
        ...
        <div id="modalEditDigesto" class="fixed inset-0 z-50 hidden">
            ...
            <div
                class="relative mx-auto mt-10 w-[95%] max-w-2xl bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
                <div class="px-6 py-4 border-b bg-gray-50 flex items-start justify-between gap-3">
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1">Podés modificar título/descripcion y re-subir el PDF si el
                            deploy borró el archivo.</p>
                    </div>
                    <button type="button"
                ...
                <div class="p-6">
                    <form id="formEditDigesto" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 gap-5">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Reemplazar PDF
                                    (opcional)</label>
        ...
        <script>
            async function openEditDigesto(id) {
                ...
                try {
                    const r = await fetch(`{{ url('/edured/herramientas/digesto') }}/${id}/edit`, {
                        method: 'GET',
                        headers: {
                    ...
                    if (!r.ok) {
                        // esto te deja el motivo real en consola (302/401/404/500)
                        const text = await r.text().catch(() => '');
                        console.error('EDIT DIGESTO ERROR:', r.status, text);
